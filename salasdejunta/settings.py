"""
Django settings for salasdejunta project.
...
SECRET_KEY = 'django-insecure-kgc1@^o!dy*667+9j3&$!++#_nd&n9)up-cltdqu^(k^0+f)nb'
...
ROOT_URLCONF = 'salasdejunta.urls'
...
WSGI_APPLICATION = 'salasdejunta.wsgi.application'
